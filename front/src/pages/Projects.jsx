...
const Projects = () => {
  ...
  document.body.style = "background: url('" + bgImg + "'); background-color: var(--c_bright); background-blend-mode: multiply; background-size: cover; background-attachment: fixed;";
        ...
        <div className='list'>
          {
            loading ? <p>Cargando...</p>
              : projects.length ? projects.map(p => <ProjectPreview key={p._id} {...p}/>)
                : <p> <br /> Actualmente no tienes ningún proyecto creado.</p>
          }
        </div>
      </div>
